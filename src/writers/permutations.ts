 ...
 * @returns void.
 */
export const writeTypeScriptSassESLintMongoDBContext = async (
	name: string,
	basePath: string,
	options: Options
): Promise<void> => {
 ...
 * @returns void.
 */
export const writeTypeScriptESLintMongoDBContext = async (
	name: string,
	basePath: string,
	options: Options
): Promise<void> => {
 ...
 * @returns void.
 */
export const writeTypeScriptSassMongoDBContext = async (
	name: string,
	basePath: string,
	options: Options
): Promise<void> => {
 ...
 * @returns void.
 */
export const writeJavaScriptSassESLintMongoDBContext = async (
	name: string,
	basePath: string,
	options: Options
): Promise<void> => {
